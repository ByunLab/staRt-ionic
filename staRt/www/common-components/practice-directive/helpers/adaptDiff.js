...
/*
function revise_difficulty(diffLevel, carrierPhrases, cb) {

  switch (diffLevel) {
    case 1:
      console.log('DiffLevel is now :' + diffLevel);
      cb();
      break;
    case 2:
      console.log('DiffLevel is now :' + diffLevel);
    ...
    case 3:
      console.log('DiffLevel is now :' + diffLevel);
      carrierPhrases = carrier_phrases_bank[0];
      cb();
      break;
    case 4:
      console.log('DiffLevel is now :' + diffLevel);
      carrierPhrases = carrier_phrases_bank[1];
      cb();
      break;
    case 5:
    console.log('DiffLevel is now :' + diffLevel);
      //carrier_phrases = carrier_phrases_bank[2];
      carrierPhrases = carrier_phrases_bank[2];
      cb();
      break;
    default:
  }
...
// function checkDifficulty(perfScore, diffLevel, carrierPhrases) {
//   console.log('performance: ' + perfScore);
//   console.log('diff level: ' + diffLevel);
//
//   if (perfScore >= increase_difficulty_threshold &&
//     diffLevel < 5) {
//     console.log('INCREASING DIFFICULTY');
//     diffLevel++;
//     console.log('diff level: ' + diffLevel);
//     // revise_difficulty( diffLevel, carrierPhrases, cb );
//
//     //return $scope.reloadCSVData();
//   } else if (perfScore <= decrease_difficulty_threshold &&
//     diffLevel > 1) {
...
/*
function checkDifficulty(perfScore, difficulty) {
    console.log('performance: ' + perfScore);
    console.log('diff level: ' + difficulty);
